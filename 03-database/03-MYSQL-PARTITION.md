...
ALTER TABLE `crm_order_info` PARTITION BY RANGE COLUMNS(`gmt_create`) (
    PARTITION op201799 VALUES LESS THAN ('2018-01-01'), -- 2017年 + 2017年以前的数据分区
    PARTITION op201899 VALUES LESS THAN ('2019-01-01'), -- 2018年
    PARTITION op2019q1 VALUES LESS THAN ('2019-04-01'), -- 2019年1季度
    ...
    PARTITION op2020q3 VALUES LESS THAN ('2020-10-01'), -- 2020年3季度
    PARTITION op999999 VALUES LESS THAN maxvalue
);
...
-- 重新组织分区：合并分区
ALTER TABLE `crm_order_info` REORGANIZE PARTITION op2018q1,op2018q2,op2018q3,op2018q4 INTO (
    PARTITION op201899 VALUES LESS THAN ('2019-01-01')
);

-- 重新组织分区：拆分分区
ALTER TABLE `crm_order_info` REORGANIZE PARTITION op999999 INTO (
    PARTITION op2020q3 VALUES LESS THAN ('2020-10-01'),
    PARTITION op999999 VALUES LESS THAN maxvalue
);

-- 删除分区
-- ALTER TABLE crm_order_info DROP PARTITION op2018q1;
...
-- 按分区查询
SELECT *
  FROM crm_order_info PARTITION(op201899)
 LIMIT 100
;
```
...
-- 普通表与分区表之间，交换分区就搞定了
ALTER TABLE crm_order_info EXCHANGE PARTITION op201799 WITH TABLE crm_order_info_archive_2017;
```
